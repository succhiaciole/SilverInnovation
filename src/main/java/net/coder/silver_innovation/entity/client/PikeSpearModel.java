...
@OnlyIn(Dist.CLIENT)
public class PikeSpearModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(SilverInnovation.MOD_ID, "textures/entity/pike_spear.png");
    private final ModelPart root;

    public PikeSpearModel(ModelPart pRoot) {
