package net.ohfired.silver_innovation.worldgen.tree.custom;
...
public class MahoganyTrunkPlacer extends TrunkPlacer {
    ...
    public static final Codec<MahoganyTrunkPlacer> CODEC = RecordCodecBuilder.create((p_273579_) -> {
        ...
        }))).apply(p_273579_, MahoganyTrunkPlacer::new);
    });

    public MahoganyTrunkPlacer (int p_273281_, int p_273327_, int p_272619_, IntProvider p_272873_, IntProvider p_272789_, UniformInt p_272917_, IntProvider p_272948_) {
    ...
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.MAHOGANY_TRUNK_PLACER.get();
    }
