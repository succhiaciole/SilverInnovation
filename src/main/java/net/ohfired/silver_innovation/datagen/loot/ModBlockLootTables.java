package net.ohfired.silver_innovation.datagen.loot;

import net.ohfired.silver_innovation.block.ModBlocks;
import net.ohfired.silver_innovation.block.custom.StrawberryBushBlock;
import net.ohfired.silver_innovation.block.custom.StrawberryCropBlock;
