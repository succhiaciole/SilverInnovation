...
public class ModEnchantments {
    ...
    public static final RegistryObject<Enchantment> DEEPSEEK = ENCHANTMENTS.register("deepseek",
            () -> new DeepseekEnchantment(Enchantment.Rarity.VERY_RARE, EquipmentSlot.MAINHAND));
